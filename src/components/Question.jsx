...
export default function Question(props) {
    // shuffle the incorrect answer and correct answer
    // only display with original order once, set initial state as a callback function will help me achieve this effect
